...
#+END_SRC
** Some perspective
This is essentially tagged workspaces in emacs. Therefore all the
things that you work on don't get mushed together in one large list
of buffers.

#+BEGIN_SRC emacs-lisp
 ; (packages-require 'persp-mode)
;  (persp-mode)
#+END_SRC
** Rainbow delimiters
